	...
	return (
		<main className={cx(styles.container)}>
			...
			<IntInput
				...
				initialValue={bombs.type === 'Ok' ? bombs.data : undefined}
				min={1}
				max={width.type === 'Ok' && height.type === 'Ok' ? (width.data * height.data) / 2 : undefined}
				inputProps={{ id: 'bombs', className: bombs.type === 'Err' ? styles.error : undefined }}
			/>
			...
			<IntInput
				...
				initialValue={width.type === 'Ok' ? width.data : undefined}
				min={2}
				max={100}
				inputProps={{ id: 'width', className: width.type === 'Err' ? styles.error : undefined }}
			/>
			...
			<IntInput
				...
				initialValue={height.type === 'Ok' ? height.data : undefined}
				min={2}
				max={100}
				inputProps={{ id: 'height', className: height.type === 'Err' ? styles.error : undefined }}
			/>
